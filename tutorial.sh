...
./tutorial -g my_first_generator -o . target=host
...
./tutorial -g my_first_generator -e stmt -o . target=host
...
./tutorial -g my_second_generator -f my_second_generator_1 -o . \
target=host parallel=false scale=3.0 rotation=ccw output.type=uint16

./tutorial -g my_second_generator -f my_second_generator_2 -o . \
target=host scale=9.0 rotation=ccw output.type=float32

./tutorial -g my_second_generator -f my_second_generator_3 -o . \
...
# different versions of the first pipeline for different arm variants:
...
./tutorial \
    -r halide_runtime_arm \
    -e object,c_header\
    -o . \
    target=host-arm-64
check_runtime halide_runtime_arm.o

# Linking the standalone runtime with the three generated object files
# gives us three versions of the pipeline for varying levels of arm,
# combined with a single runtime that will work on nearly all arm
# processors.
ar q my_first_generator_multi.a \
    my_first_generator_basic.o \
    halide_runtime_arm.o
